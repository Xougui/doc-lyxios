...
export const sortedStaff = [...staff].sort((a, b) => {
  // Priorité 1: xougui
  if (a.id === '946098490654740580') return -1;
  if (b.id === '946098490654740580') return 1;

  // Priorité 2: kadawatcha
  if (a.id === '1178647820052467823') return -1;
  if (b.id === '1178647820052467823') return 1;

  // Tri par rôle pour les autres
  const roleIndexA = getRoleIndex(a.id);
  const roleIndexB = getRoleIndex(b.id);
